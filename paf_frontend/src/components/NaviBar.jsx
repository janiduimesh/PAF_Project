...
import ChatBot from '../pages/ChatBot'; // ✅ import your popup component
...
function NaviBar() {
  ...
  return (
    <>
      ...
      >
        <Box>
          <Toolbar sx={{ background: 'linear-gradient(145deg, #f5f5f5, #e6e6e6)', borderBottom: '1px solid #ddd' }} />
