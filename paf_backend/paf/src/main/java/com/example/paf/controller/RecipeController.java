...
public class RecipeController {
    ...
    @PostMapping("/create")
    @ResponseStatus(HttpStatus.CREATED)
    public String createRecipe(@ModelAttribute RecipeTO recipe, Principal principal) {
        System.out.println("Logged-in user email: " + principal.getName()); 
        return recipeService.createRecipe(recipe, principal.getName()); 
}
